        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('candidate.resumes') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-file-docs"></em></span>
                            <span class="nk-menu-text">{{ __('Mon Curriculum Vitae') }}</span>
                        </a>
                    </li><!-- .nk-menu-item -->

                    <li class="nk-menu-item">
                        <a href="{{ route('candidate.messages') }}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('candidate.applied-jobs') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-view-list-fill"></em></span>
                            <span class="nk-menu-text">{{ __('Mes candidatures') }}</span>
                        </a>
                    </li><!-- .nk-menu-item -->

                    <li class="nk-menu-item">
                        <a href="{{ route('candidate.recommendations') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-bell-fill"></em></span>
                            <span class="nk-menu-text">{{ __('Nos recommandations') }}</span></span> <span class="nk-menu-badge">2</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    ...
                    <li class="nk-menu-item">
                        <a href="{{ route('candidate.profile') }}" class="nk-menu-link">
